...
//  TCVideo_Study
//
//  Created by tcan on 2018/1/10.
//  Copyright © 2018年 tcan. All rights reserved.
//
...
extension RoomViewModel {
    func loadLiveURL(_ roomid : Int, _ userId : String, _ completion : @escaping () -> ()) {
        ...
        NetworkTool.getRequestWithURL(path: URLString, parameter: parameters, success: { result in
            // 1.获取结果字典
